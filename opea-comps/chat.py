...
def align_inputs(self, inputs, cur_node, runtime_graph, llm_parameters_dict, **kwargs):
    print(f"{cur_node} for the love of alll things {inputs}")
    if self.services[cur_node].service_type == ServiceType.LLM:
        next_inputs = {}
        next_inputs["model"] = "llama3.2:1b"  # specifically clarify the fake model to make the format unified
...
if __name__ == "__main__":
    ...
    chatbot = ChatbotService(port=MEGA_SERVICE_PORT)
    chatbot.add_remote_service()
    chatbot.start()